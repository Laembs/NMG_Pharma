...
#define MyAppDisplayName "NMGone V1.2 SP2"
...
OutputBaseFilename=NMGone_Setup_1_2_2
...
begin
  ...
  Msg := 'NMGone V1.2 SP2 wird installiert.' + #13#10#13#10 +
         'Service Pack 2:' + #13#10 +
         '- Kasse: grafischer Umbau (moderne Oberflaeche, Navigation, Tabellen)' + #13#10 +
         '- Kunden: neue Reiter-Maske (Stammdaten/Rabatte/Analysen/Notizen)' + #13#10 +
         '- Kunden: Formular ausgebaut + PLZ-Pruefung mit Ort-Autofill' + #13#10 +
         '- Artikel-Rabatte je Kunde wirken direkt in der Kasse' + #13#10 +
         '- Anzeige "ZF" heisst jetzt "ZW" (nur Beschriftung)';
