...
#define MyAppDisplayName "NMGone V1.1 SP4"
...
OutputBaseFilename=NMGone_Setup_1_1_4
...
begin
  ...
  Msg := 'NMGone V1.1 SP4 wird installiert.' + #13#10#13#10 +
         'Service Pack 4 zu V1.1.0.' + #13#10#13#10 +
         'Vergleichs-Suche - Filter mit # ergaenzen:' + #13#10 +
         '- gliv #nmg          nur NMG-Stamm-Treffer fuer gliv' + #13#10 +
         '- ramipril #wirkstoff   nur Wirkstoff-Match' + #13#10 +
         '- noris #herst       nur Hersteller-Match' + #13#10 +
         '- humira #austausch  nur mit Austausch-Eintrag' + #13#10 +
         '- foo #schulbank     nur manuelle Schulbank-Eintraege' + #13#10 +
         '- mehrere Filter werden UND-verknuepft' + #13#10 +
