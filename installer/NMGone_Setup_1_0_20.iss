...
#define MyAppDisplayName "NMGone V1.0 SP20"
...
OutputBaseFilename=NMGone_Setup_1_0_20
...
begin
  ...
  Msg := 'NMGone V1.0 SP20 wird installiert.' + #13#10#13#10 +
         'Fix: Bei mehreren Austausch-Treffern wird der erste in Spalte NMG PZN' + #13#10 +
         '     uebernommen, alle weiteren als "austauschbar gegen ..." aufgelistet.' + #13#10 +
         'Neu: Modaler "NMGone arbeitet ..."-Dialog bei laenger laufenden Aktionen.';
