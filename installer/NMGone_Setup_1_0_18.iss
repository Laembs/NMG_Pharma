...
#define MyAppDisplayName "NMGone V1.0 SP18"
...
OutputBaseFilename=NMGone_Setup_1_0_18
...
begin
  ...
  Msg := 'NMGone V1.0 SP18 wird installiert.' + #13#10#13#10 +
         'Fix: Schulbank-Loeschen wirkt jetzt auch fuer uebernommene Eintraege' + #13#10 +
         '(die in der Austauschdatenbank gespeichert sind).';
