...
#define MyAppDisplayName "NMGone V1.0 SP19"
...
begin
  ...
  Msg := 'NMGone V1.0 SP19 wird installiert.' + #13#10#13#10 +
         'Neu: Schulbank-Bereich "Biosimilar" fuer Importdaten' + #13#10 +
         'Fix: Neue Auswertung fuellt Artikelname/DF/Pck/Herst/EK aus Stammdaten,' + #13#10 +
         '     Biosimilar-Treffer kommen wieder in die Auswertung.';
