...
#define MyAppDisplayName "NMGone V1.1 SP20"
...
OutputBaseFilename=NMGone_Setup_1_1_20
...
VersionInfoProductVersion=1.1.20
...
; V1.1 SP19: Auto-Restart nach Update. Ohne "postinstall" => NMGone wird
; IMMER nach Setup-Abschluss gestartet (skipifsilent schliesst silent-Install aus).
...
begin
  ...
  Msg := 'NMGone V1.1 SP20 wird installiert.' + #13#10#13#10 +
         'Service Pack 20 zu V1.1.0.' + #13#10#13#10 +
         'NMG-Rabatte bearbeiten:' + #13#10 +
         '- Tabelle zeigt jetzt Artikel, DF und Pack' + #13#10 +
         '- Doppelklick auf eine Zeile = Rabatt aendern' + #13#10 +
         '- Aenderung wird mit Datum + Benutzer protokolliert' + #13#10 +
         '  (gleicher Rabatt => kein Log-Eintrag)' + #13#10 +
         '- "Gueltig ab"-Datum pro Rabatt setzbar' + #13#10#13#10 +
         'Import:' + #13#10 +
         '- Beim PK-Rabatte-Import wird abgefragt, ab wann die' + #13#10 +
         '  Rabatte gelten sollen (Datei-Spalte hat Vorrang)' + #13#10 +
         '- Verlauf-Reiter zeigt manuelle Aenderungen (wer/wann)';
