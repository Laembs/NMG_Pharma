...
#define MyAppDisplayName "NMGone V1.1 SP15"
...
begin
  ...
  Msg := 'NMGone V1.1 SP15 wird installiert.' + #13#10#13#10 +
         'Service Pack 15 zu V1.1.0 - Background-Imports.' + #13#10#13#10 +
         'Manuelle Imports laufen ab jetzt im HINTERGRUND:' + #13#10 +
         '- Kein Modal-Dialog mehr, der die UI blockiert' + #13#10 +
         '- Statt dessen Status-Box rechts oben mit Titel,' + #13#10 +
         '  aktueller Datei und Fortschritts-Balken' + #13#10 +
         '- Programm bleibt waehrend des Imports klickbar' + #13#10 +
         '- Mehrere Imports koennen parallel laufen' + #13#10 +
         '- Nach Abschluss verschwindet die Box, Statistik-Toast' + #13#10 +
