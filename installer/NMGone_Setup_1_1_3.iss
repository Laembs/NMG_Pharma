...
#define MyAppDisplayName "NMGone V1.1 SP3"
...
OutputBaseFilename=NMGone_Setup_1_1_3
...
begin
  ...
  Msg := 'NMGone V1.1 SP3 wird installiert.' + #13#10#13#10 +
         'Service Pack 3 zu V1.1.0.' + #13#10#13#10 +
         'Vergleichs-Suche - Quelle pro Austauschartikel:' + #13#10 +
         '- Detail-Panel zeigt jetzt die Quelle (Schulbank, Biosimilar,' + #13#10 +
         '  Import) als eigene Spalte in der Austauschartikel-Tabelle' + #13#10#13#10 +
         'Datenbankuebersicht - Cleanup direkt zugaenglich:' + #13#10 +
         '- neuer Toolbar-Button "Datenbankinhalte leeren"' + #13#10 +
         '- oeffnet den bekannten Cleanup-Dialog mit Checkbox je Tabelle' + #13#10 +
         '- Passwort + LEEREN-Confirm + automatisches Backup vorher' + #13#10 +
         '- Ctrl+Alt+A-Toggle nicht mehr noetig';
