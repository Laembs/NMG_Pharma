...
#define MyAppDisplayName "NMGone V1.0 SP2"
#define MyAppVersion "1.0.2"
#define MyAppPublisher "Laembs Software"
#define MyAppExeName "NMGone.exe"

[Setup]
; Gleiche AppId wie V1.0 / SP1: V1.0 SP2 wird drueberinstalliert.
; Daten unter C:\ProgramData\NMGone bleiben.
...
OutputBaseFilename=NMGone_Setup_1_0_2
...
var
  Msg: String;
begin
  Msg := 'NMGone V1.0 SP2 wird installiert oder ueber bestehende Version aktualisiert.' + #13#10#13#10 +
         'Vorhandene Daten unter C:\ProgramData\NMGone bleiben erhalten.' + #13#10 +
         'Neu in SP2: Auto-Update-Check, sichtbare Import-Fehler, Layout-Cleanup.';
