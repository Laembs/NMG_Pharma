...
#define MyAppDisplayName "NMGone V2.1 SP2"
...
OutputBaseFilename=NMGone_Setup_2_1_2
...
begin
  ...
  Msg := 'NMGone V2.1 SP2 wird installiert.' + #13#10#13#10 +
         'Service Pack 2 baut die App "Wareneingang & Retouren" (GDP) zum' + #13#10 +
         'kompletten Warenkreislauf aus:' + #13#10 +
         '- Betriebsmodus Verkauf / Produktion je Arbeitsplatz' + #13#10 +
         '- Einkauf -> Produktion -> Warenausgang (Avis) -> Bestaetigung im Verkauf' + #13#10 +
         '- Retourenbestand (Quarantaene), Bestandsdifferenzen, Warenbewegungen' + #13#10 +
         '- Protokoll mit Zeitraum-Auswertung (Monat/Quartal/Jahr/Vorjahr/manuell)';
