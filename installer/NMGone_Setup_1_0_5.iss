...
#define MyAppDisplayName "NMGone V1.0 SP5"
...
OutputBaseFilename=NMGone_Setup_1_0_5
...
var
  Msg: String;
begin
  Msg := 'NMGone V1.0 SP5 wird installiert oder ueber bestehende Version aktualisiert.' + #13#10#13#10 +
         'Vorhandene Daten unter C:\ProgramData\NMGone bleiben erhalten.' + #13#10 +
         'Neu in SP5: Updates landen lokal in C:\ProgramData\NMGone\updates und koennen offline installiert werden.';
