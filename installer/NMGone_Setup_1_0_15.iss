...
#define MyAppDisplayName "NMGone V1.0 SP15"
...
OutputBaseFilename=NMGone_Setup_1_0_15
...
begin
  ...
  Msg := 'NMGone V1.0 SP15 wird installiert.' + #13#10#13#10 +
         'Neu: Produktanalyse v2 - Stammdaten aus Artikelstamm, EK-Spalte hinzu,' + #13#10 +
         'Austausch-Artikel werden gefiltert.';
