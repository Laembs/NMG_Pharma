...
#define MyAppDisplayName "NMGone V1.1.0"
...
OutputBaseFilename=NMGone_Setup_1_1_0
...
begin
  ...
  Msg := 'NMGone V1.1.0 wird installiert.' + #13#10#13#10 +
         'Meilenstein-Release. Folgeversionen kommen als V1.1 SP1, SP2 ...' + #13#10#13#10 +
         'Neu: Vergleichs-Suche als eigenes Fenster.' + #13#10 +
         '- Live-Suche nach PZN ODER Artikelname ab 3 Zeichen' + #13#10 +
         '- sucht parallel in Austauschdatenbank, NMG-Stamm,' + #13#10 +
         '  Artikelstamm und PZN-Basisdaten' + #13#10 +
         '- Treffer pro PZN nur einmal, mit DF / PCK / Hersteller' + #13#10 +
         '- Detail-Panel rechts zeigt Austauschartikel als Tabelle' + #13#10 +
         '  (PZN, Artikelname, DF, PCK, Hersteller nebeneinander)' + #13#10 +
         '- laeuft im Hintergrund-Thread, UI bleibt klickbar' + #13#10 +
         '- Apps-Kachel + Dashboard-Editor-Eintrag' + #13#10#13#10 +
         'Weitere Verbesserungen:' + #13#10 +
         '- Dashboard-Editor ~20%% kleiner, nicht mehr maximiert' + #13#10 +
         '- alle Apps werden ueber den Dashboard-Editor verwaltbar';
