...
#define MyAppDisplayName "NMGone V1.0 SP13"
...
OutputBaseFilename=NMGone_Setup_1_0_13
...
begin
  ...
  Msg := 'NMGone V1.0 SP13 wird installiert.' + #13#10#13#10 +
         'Neu in SP13: Detaillierte Import-Diagnose im Abschluss-Dialog' + #13#10 +
         '(Spalten erkannt, Zeilen gelesen, Tabellen-Stand vorher/nachher).';
  if CleanedHKCU then
