...
#define MyAppDisplayName "NMGone V1.0 SP3"
...
OutputBaseFilename=NMGone_Setup_1_0_3
...
var
  Msg: String;
begin
  Msg := 'NMGone V1.0 SP3 wird installiert oder ueber bestehende Version aktualisiert.' + #13#10#13#10 +
         'Vorhandene Daten unter C:\ProgramData\NMGone bleiben erhalten.' + #13#10 +
         'Neu in SP3: Admin sieht alle Tabellen, Warte-Dialog mit Logo bei langen Importen.';
