...
#define MyAppDisplayName "NMGone V1.0 SP28"
...
OutputBaseFilename=NMGone_Setup_1_0_28
...
VersionInfoProductVersion=1.0.28
...
begin
  ...
  Msg := 'NMGone V1.0 SP28 wird installiert.' + #13#10#13#10 +
         'Fix: PK-Rabatte werden beim Import jetzt korrekt erkannt -' + #13#10 +
         '     auch "15%" als Text und nackte Zahlen wie 15 (= 15%).' + #13#10 +
         'Neu: Statusliste zeigt PK-Rabatte als (gesamt / davon mit Wert)' + #13#10 +
         '     sodass NULL-Eintraege auffallen. Counter ehrlich.';
