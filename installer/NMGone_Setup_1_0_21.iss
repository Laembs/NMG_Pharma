...
#define MyAppDisplayName "NMGone V1.0 SP21"
...
OutputBaseFilename=NMGone_Setup_1_0_21
...
begin
  ...
  Msg := 'NMGone V1.0 SP21 wird installiert.' + #13#10#13#10 +
         'Fix: Bei mehreren NMG-PZN-Kandidaten waehlt die Auswertung jetzt die' + #13#10 +
         '     PZN mit dem hoechsten PK-Rabatt als Hauptreffer; alle anderen' + #13#10 +
         '     bleiben in "austauschbar gegen" sichtbar.';
