...
#define MyAppDisplayName "NMGone V1.0 SP27"
...
OutputBaseFilename=NMGone_Setup_1_0_27
...
VersionInfoProductVersion=1.0.27
...
begin
  ...
  Msg := 'NMGone V1.0 SP27 wird installiert.' + #13#10#13#10 +
         'Speed: Neue Auswertung deutlich schneller. Die Wissens-Tabellen' + #13#10 +
         '       (NMG-Stamm, Rabatte, Lieferbarkeit, Schulbank, Artikelstamm)' + #13#10 +
         '       werden einmal vorab in den RAM geladen, danach laeuft jede' + #13#10 +
         '       Zeile per Dict-Lookup statt SQL-Query.';
