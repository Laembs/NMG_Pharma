...
#define MyAppDisplayName "NMGone V1.0 SP26"
...
OutputBaseFilename=NMGone_Setup_1_0_26
...
VersionInfoProductVersion=1.0.26
...
begin
  ...
  Msg := 'NMGone V1.0 SP26 wird installiert.' + #13#10#13#10 +
         'Neu: Anzahl der Eintraege wird hinter jeder Wissensbasis angezeigt' + #13#10 +
         '     (APU/HAP, NMG-Artikel, PK-Rabatte, Artikelstamm, Schulbank,' + #13#10 +
         '     Lieferfaehigkeit). Beim Start warnt das Programm jetzt, wenn' + #13#10 +
         '     eine wichtige Tabelle leer ist.';
