...
#define MyAppDisplayName "NMGone V1.1 SP5"
...
OutputBaseFilename=NMGone_Setup_1_1_5
...
begin
  ...
  Msg := 'NMGone V1.1 SP5 wird installiert.' + #13#10#13#10 +
         'Service Pack 5 zu V1.1.0.' + #13#10#13#10 +
         'Hersteller-Filter mit # in der Vergleichs-Suche:' + #13#10 +
         '- gliv #hexal     nur Treffer mit Hersteller hexal' + #13#10 +
         '- humira #ratio   nur Treffer mit Hersteller ratio' + #13#10 +
         '- gliv #nmg #hexal   NMG-Stamm UND Hersteller hexal' + #13#10#13#10 +
         'System-Filter wie bisher:' + #13#10 +
         '- #nmg, #austausch, #schulbank, #wirkstoff' + #13#10 +
         '- alle Filter werden UND-verknuepft' + #13#10 +
         '- #herst (ohne Wert) ist entfallen';
