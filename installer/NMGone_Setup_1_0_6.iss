...
#define MyAppDisplayName "NMGone V1.0 SP6"
...
OutputBaseFilename=NMGone_Setup_1_0_6
...
var
  Msg: String;
begin
  Msg := 'NMGone V1.0 SP6 wird installiert oder ueber bestehende Version aktualisiert.' + #13#10#13#10 +
