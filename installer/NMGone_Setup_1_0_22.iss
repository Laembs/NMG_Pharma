...
#define MyAppDisplayName "NMGone V1.0 SP22"
...
OutputBaseFilename=NMGone_Setup_1_0_22
...
VersionInfoProductVersion=1.0.22
...
begin
  ...
  Msg := 'NMGone V1.0 SP22 wird installiert.' + #13#10#13#10 +
         'Fix: In Spalte "austauschbar gegen" werden nur noch Artikel gelistet,' + #13#10 +
         '     deren PZN tatsaechlich im NMG-Stamm vorhanden ist. Freitext-' + #13#10 +
         '     Eintraege ohne pruefbare NMG-PZN werden ausgeblendet.';
