...
#define MyAppDisplayName "NMGone V1.1 SP2"
...
OutputBaseFilename=NMGone_Setup_1_1_2
...
begin
  ...
  Msg := 'NMGone V1.1 SP2 wird installiert.' + #13#10#13#10 +
         'Service Pack 2 zu V1.1.0.' + #13#10#13#10 +
         'Wirkstoff- und Staerken-Datenbank:' + #13#10 +
         '- neue Tabelle tbl_wirkstoff_staerke mit Wirkstoff + Staerke je PZN' + #13#10 +
         '- Import-Button in der Datenbankuebersicht' + #13#10 +
         '- Import laeuft im Hintergrund-Thread mit Fortschrittsanzeige' + #13#10#13#10 +
         'Vergleichs-Suche erweitert:' + #13#10 +
         '- Suche jetzt auch nach Wirkstoff (z.B. Ramipril)' + #13#10 +
         '- Suche jetzt auch nach Hersteller (z.B. HEUMA)' + #13#10 +
         '- Suche jetzt auch nach Staerke (z.B. 2.5MG)' + #13#10 +
         '- Detail-Panel zeigt Wirkstoff + Staerke pro Artikel';
