...
#define MyAppDisplayName "NMGone V1.0 SP23"
...
OutputBaseFilename=NMGone_Setup_1_0_23
...
VersionInfoProductVersion=1.0.23
...
begin
  ...
  Msg := 'NMGone V1.0 SP23 wird installiert.' + #13#10#13#10 +
         'Fix: NMG-Austausch wird jetzt bevorzugt nach einem echten Rabatt-' + #13#10 +
         '     Eintrag in nmg_rabatte ausgewaehlt. Erst wenn keiner einen' + #13#10 +
         '     Rabatt-Eintrag hat, wird ein NMG-Stamm-Kandidat als Haupt' + #13#10 +
         '     gewaehlt (Rabatt-Spalte bleibt leer).';
