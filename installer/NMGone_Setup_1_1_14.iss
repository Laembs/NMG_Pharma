...
#define MyAppDisplayName "NMGone V1.1 SP14"
...
begin
  ...
  Msg := 'NMGone V1.1 SP14 wird installiert.' + #13#10#13#10 +
         'Service Pack 14 zu V1.1.0 - Import-Fortschritt.' + #13#10#13#10 +
         'Bei manuellen Imports wird jetzt im Busy-Dialog angezeigt,' + #13#10 +
         'welche Datei gerade verarbeitet wird:' + #13#10 +
         '   "Datei 5 von 96: foo.xlsx"' + #13#10#13#10 +
         'Damit sieht man bei groesseren Import-Stapeln, wo das' + #13#10 +
         'Programm gerade steht - kein leeres "Bitte warten" mehr.' + #13#10#13#10 +
         'Technisch: _run_busy hat einen neuen Modus progress=True,' + #13#10 +
         'der dem Worker-Funktion ein progress(text)-Callable als' + #13#10 +
         'Argument durchreicht. import_manual_analysis_files nutzt das' + #13#10 +
         'pro Datei.';
