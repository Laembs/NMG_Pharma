...
#define MyAppDisplayName "NMGone V1.0 SP7"
...
OutputBaseFilename=NMGone_Setup_1_0_7
...
var
  Msg: String;
begin
  Msg := 'NMGone V1.0 SP7 wird installiert oder ueber bestehende Version aktualisiert.' + #13#10#13#10 +
