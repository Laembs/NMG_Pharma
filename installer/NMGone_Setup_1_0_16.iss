...
#define MyAppDisplayName "NMGone V1.0 SP16"
...
OutputBaseFilename=NMGone_Setup_1_0_16
...
begin
  ...
  Msg := 'NMGone V1.0 SP16 wird installiert.' + #13#10#13#10 +
         'Neu: Austausch-Suche auf der Startseite - PZN eingeben,' + #13#10 +
         'NMG-Ersatz mit Artikel/Hersteller wird angezeigt.';
