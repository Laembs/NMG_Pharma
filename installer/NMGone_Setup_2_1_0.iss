...
#define MyAppDisplayName "NMGone V2.1.0"
...
OutputBaseFilename=NMGone_Setup_2_1_0
...
begin
  ...
  Msg := 'NMGone V2.1.0 wird installiert.' + #13#10#13#10 +
         'Neuer Meilenstein V2.1.0 - die komplette Suite in einer stabilen Version:' + #13#10 +
         '- Bedarfsanalyse, Mitarbeiter & Personal, Kasse, Faktura, Report' + #13#10 +
         '- Bebildertes Handbuch (Hilfe) fuer alle Module vervollstaendigt' + #13#10 +
         '- Anpassbare Vorlagen: Lieferschein und Defektmeldung' + #13#10 +
         '- Einheitliches Design ueber alle Programme';
