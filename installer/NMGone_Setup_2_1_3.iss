...
#define MyAppDisplayName "NMGone V2.1 SP3"
...
OutputBaseFilename=NMGone_Setup_2_1_3
...
begin
  ...
  Msg := 'NMGone V2.1 SP3 wird installiert.' + #13#10#13#10 +
         'Service Pack 3 baut die Einkauf-App zum Markt-Scout fuer den' + #13#10 +
         'Parallelimport-Einkauf aus:' + #13#10 +
         '- Importkandidaten aus den Bedarfsanalysen (Potenzial in Euro, §129-Ampel)' + #13#10 +
         '- Wettbewerb je Wirkstoff (wie viele Reimporteure schon aktiv sind)' + #13#10 +
         '- Nachfrage-Trend, Pipeline-Status, Merkliste und Break-even-Rechner' + #13#10 +
         '- Bevorzugte Lieferanten + Lieferant<->Hersteller-Zuordnung' + #13#10 +
         '- Neue Seite "Statistik & Erfolg" (Lieferanten- und Hersteller-Auswertung)';
