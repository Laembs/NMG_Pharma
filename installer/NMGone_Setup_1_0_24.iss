...
#define MyAppDisplayName "NMGone V1.0 SP24"
...
OutputBaseFilename=NMGone_Setup_1_0_24
...
VersionInfoProductVersion=1.0.24
...
begin
  ...
  Msg := 'NMGone V1.0 SP24 wird installiert.' + #13#10#13#10 +
         'Fix: PK-Rabatte werden nun zuverlaessig gefunden. Bisher schlug' + #13#10 +
         '     der Tabellen-Join wegen unterschiedlicher PZN-Formate fehl' + #13#10 +
         '     (z.B. fuehrende Nullen, Excel-Zahl). PZNs werden jetzt im' + #13#10 +
         '     Lookup und beim Import einheitlich auf 8 Stellen normalisiert.';
