...
#define MyAppDisplayName "NMGone V1.1 SP17"
...
OutputBaseFilename=NMGone_Setup_1_1_17
...
VersionInfoProductVersion=1.1.17
...
begin
  ...
  Msg := 'NMGone V1.1 SP17 wird installiert.' + #13#10#13#10 +
         'Service Pack 17 zu V1.1.0 - nicht-erkannte Dateien skippen.' + #13#10#13#10 +
         'Beim manuellen Import wurden bisher nicht-erkannte Dateien' + #13#10 +
         'mit einem Modal-Dialog pro Datei angeboten ("Soll der Format-' + #13#10 +
         'Assistent geoeffnet werden?") - bei vielen Dateien blockierte' + #13#10 +
         'das den Stapel.' + #13#10#13#10 +
         'Jetzt:' + #13#10 +
         '- Alle nicht-erkannten Dateien werden uebersprungen' + #13#10 +
         '- Eine TXT-Sammeldatei wird angelegt unter' + #13#10 +
         '  importierte_analysen/<PK|ZF>/<Jahr>/Q<n>/' + #13#10 +
         '  mit Dateinamen + Fehlertext' + #13#10 +
         '- Am Ende EINE einmalige Frage: "Sollen die N nicht-erkannten' + #13#10 +
         '  Dateien jetzt manuell gemapped werden?"' + #13#10#13#10 +
         'Plus Aufraeumarbeit: doppelte Statistik-Messagebox am Ende' + #13#10 +
         'des Imports war drin - jetzt nur noch einmal.';
