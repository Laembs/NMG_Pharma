...
#define MyAppDisplayName "NMGone V1.1 SP18"
...
begin
  ...
  Msg := 'NMGone V1.1 SP18 wird installiert.' + #13#10#13#10 +
         'Service Pack 18 zu V1.1.0.' + #13#10#13#10 +
         'Neue Auswertung laeuft jetzt auch im Hintergrund:' + #13#10 +
         '- Kein blockierender Modal-Dialog mehr' + #13#10 +
         '- Programm bleibt waehrend der Auswertung klickbar' + #13#10 +
         '- Status-Box mit Fortschrittsbalken in der Sidebar' + #13#10#13#10 +
         'Background-Status-Box umgezogen:' + #13#10 +
         '- Vorher: rechts oben im Header' + #13#10 +
         '- Jetzt: in der rechten Sidebar UEBER dem Backup-Status' + #13#10 +
         '- Wenn keine Jobs laufen, ist die Box nicht zu sehen';
