...
#define MyAppDisplayName "NMGone V1.0 SP10"
...
; SP10: 64-bit-Modus erzwingen. Vorher fehlte das Flag -> Inno installierte
; nach C:\Program Files (x86) statt nach C:\Program Files.
...
OutputBaseFilename=NMGone_Setup_1_0_10
...
; SP10: alte Admin-Desktop-Verknuepfungen entfernen, bevor die neue gelegt
; wird. Benutzer-Verknuepfungen ({userdesktop}, {userstartmenu}) sind im
; admin-Mode nicht sicher loeschbar - die werden vom alten SP8-Uninstaller
; sauber entfernt, der von InitializeSetup ausgefuehrt wird.
[InstallDelete]
...
; SP10: Desktop-Verknuepfung wird IMMER erstellt (keine Task-Gate, kein
; checkedonce). Sonst legt Inno bei Updates die Verknuepfung nicht neu an
; und der User klickt weiter auf eine ggf. veraltete Stelle.
[Icons]
...
begin
  ...
  Log('SP10 cleanup: alte ' + Label_ + '-Installation gefunden, deinstalliere: ' + Filename);
...
begin
  ...
  Msg := 'NMGone V1.0 SP10 wird in C:\Program Files\NMGone installiert.' + #13#10#13#10 +
         'Vorhandene Daten unter C:\ProgramData\NMGone bleiben erhalten.' + #13#10 +
         'Desktop-Verknuepfung wird neu angelegt, alte Verknuepfungen werden entfernt.';
