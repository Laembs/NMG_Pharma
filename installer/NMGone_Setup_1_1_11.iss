...
#define MyAppDisplayName "NMGone V1.1 SP11"
...
begin
  ...
  Msg := 'NMGone V1.1 SP11 wird installiert.' + #13#10#13#10 +
         'Service Pack 11 zu V1.1.0 - Optik.' + #13#10#13#10 +
         'Produktanalyse: Basis-Info und Beschreibungs-Zeile aus den' + #13#10 +
         'Excel-Sheets entfernt (Zeile 2 und 3).' + #13#10#13#10 +
         'Versionsinfo: neue Seite mit Liste aller Versionen und' + #13#10 +
         'Changelog pro Version.' + #13#10#13#10 +
         'Startseite aufgeraeumt:' + #13#10 +
         '- "Datenbankstatus"-Box weg (Werte waren nicht real)' + #13#10 +
         '- Datenbank-Name in "Aktiver Bearbeiter" weg' + #13#10#13#10 +
         'Dashboard-Editor: "Alles abwaehlen + Speichern" funktioniert' + #13#10 +
         'jetzt - leeres Set ist OK, kein Block-Dialog mehr.' + #13#10#13#10 +
         'Kacheln (Apps + Startseite-Schnellzugriff) sind jetzt alle' + #13#10 +
         'gleich gross. Einheitlicher Oeffnen-Button.';
