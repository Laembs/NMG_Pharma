...
#define MyAppDisplayName "NMGone V1.1 SP1"
...
OutputBaseFilename=NMGone_Setup_1_1_1
...
begin
  ...
  Msg := 'NMGone V1.1 SP1 wird installiert.' + #13#10#13#10 +
         'Service Pack 1 zu V1.1.0.' + #13#10#13#10 +
         'Produktanalyse stark beschleunigt:' + #13#10 +
         '- frueher: bis zu mehrere Minuten bei vielen Auswertungen' + #13#10 +
         '- jetzt: typisch unter 200 ms' + #13#10 +
         '- Hintergrund: SQL-Joins nutzen jetzt vorhandene PZN-Indizes' + #13#10 +
         '  statt fuer jede Zeile pzn_norm() neu zu berechnen' + #13#10 +
         '- Ergebnisliste und Filter-Logik unveraendert';
